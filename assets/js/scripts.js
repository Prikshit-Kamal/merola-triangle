...
/*START MARQUEE JS*/
	let lastTime = (new Date()).getTime(),
		...
		const myScroller1 = new SuperMarquee(
		  ...
		  {
			"content" : "*Comprehensive Endpoint Security* &nbsp &nbsp  *Network Security Optimization* &nbsp &nbsp  *Identity and Access Management (IAM)*  &nbsp &nbsp  *Vulnerability Management* &nbsp &nbsp  *Incident Response and Compliance Alignment* &nbsp &nbsp"
		  }
		);
